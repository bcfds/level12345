...
public class ModBiomeModifiers {
    public static final DeferredRegister<Codec<? extends BiomeModifier>> BIOME_MODIFIER_SERIALIZERS =
            DeferredRegister.create(ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, TBCcore.MOD_ID);

    public static final RegistryObject<Codec<? extends BiomeModifier>> SMILER_SPAWN_MODIFIER =
